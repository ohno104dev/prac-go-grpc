...
const (
	StudentService_GetStudentInfo_FullMethodName = "/idl.StudentService/GetStudentInfo"
)
...
func (c *studentServiceClient) GetStudentInfo(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Student, error) {
	...
	out := new(Student)
	err := c.cc.Invoke(ctx, StudentService_GetStudentInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
